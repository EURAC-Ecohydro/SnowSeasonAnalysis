...
* **Visualize_Filtering_precipitation_readings.R** that load results of Filtering_precipitation_readings.R and plot some graphs using *Shiny*.[More details](https://github.com/EURAC-Ecohydro/SnowSeasonAnalysis/tree/master/vignettes/Visualize_ESOLIP.Rmd)
