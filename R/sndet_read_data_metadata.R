...
#' Function that import and adjust data format from data/Input_data
#'
#' @param PATH path of folder where the file is saved 
...
#' Function that import Precip_T_Int15_Metadata format from file selected 
#'
#'
#' @param PATH path of folder where the file is saved 
#' @param FILE file to analyse
...
#' Function that import Units and sample type of file selected from data/Input_data/file
#'
#' @param PATH path of folder where the file is saved 
#' @param FILE file to analyse
#' 
