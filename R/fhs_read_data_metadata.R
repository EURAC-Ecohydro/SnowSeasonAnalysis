...
#' Function that import and prepare data in the standard format
#' 
...
fun_read_metadata=function(PATH,FILE){
  ...
  path_metadata=paste(substring(path,1,nchar(path)-16),"data/Output/Precipitation_metadata/Precip_T_Int_15_Metadata/",sep = "")
  # read data
  data=read.csv(paste(path_metadata,"Prec_Metadata_",FILE,sep = ""),stringsAsFactors = F)
